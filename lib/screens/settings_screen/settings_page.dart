              ...
              children: [
                ...
                Obx(
                  () => Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("${homeController.yearlyIncomeStart.value
                                .toStringAsFixed(0)} Lakh",
                        style: TextStyle(
                          color: ConstHelper.blackColor,
                          fontSize: Get.width * 0.04,
                        ),
                      ),
                      Text("${homeController.yearlyIncomeEnd.value
                                .toStringAsFixed(0)} Lakh",
                        style: TextStyle(
                          color: ConstHelper.blackColor,
                          fontSize: Get.width * 0.04,
                ...
                Obx(
                  () => Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("${homeController.selectedAgeStart.value
                                .toStringAsFixed(0)} Year",
                        style: TextStyle(
                          color: ConstHelper.blackColor,
                          fontSize: Get.width * 0.04,
                        ),
                      ),
                      Text("${homeController.selectedAgeEnd.value.toStringAsFixed(0)} Year",
                        style: TextStyle(
                          color: ConstHelper.blackColor,
                          fontSize: Get.width * 0.04,
                        ),
                ...
                //     boxShadow: [
                //       BoxShadow(
                //         color: ConstHelper.greyColor.withAlpha(128),
                ...
                Ink(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: ConstHelper.greyColor.withAlpha(51),
  ...
  Future<void> getAllMembersData() async {
    ...
    try {
      ...
      var maxHeight = int.parse(homeController.selectedMaxHeightValue.value
              ...
              .split(".")[0]) *
          12;
      debugPrint(homeController.selectedMinHeightValue.value.toString().split(".")[0]);
      debugPrint(homeController.selectedMaxHeightValue.value.toString().split(".")[0]);
      debugPrint('$minHeight');
