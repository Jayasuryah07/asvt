  ...
  filterData(String searchValue) {
    ...
    if (searchedMembersDataListGenderWise.isEmpty) {
      searchedMembersDataListGenderWise
          .assignAll(homeController.allMembersDataListGenderWise.value);
    }
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    width: 0.3,
                                    color:
                                        ConstHelper.greyColor.withOpacity(0.2),
                                  ),
                                ),
                                child: Stack(
                                  alignment: Alignment.bottomRight,
...
class ImageDialog {
  static Future<void> show(BuildContext context, List<SponItem> imageUrls,
      {int initialIndex = 0}) {
            ...
            CarouselSlider.builder(
              ...
              itemBuilder: (context, index, realIndex) {
                return InteractiveViewer(
                  child: Image.network(
                    ConstHelper.sponImgPath + (imageUrls[index].image ?? ""),
                    fit: BoxFit.contain,
